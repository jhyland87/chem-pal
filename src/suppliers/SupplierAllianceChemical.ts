...
export class SupplierAllianceChemical extends SupplierBaseShopify implements ISupplier {
  ...
  public static readonly supplierName: string = 'Alliance Chemical';

  // Base URL for HTTP(s) requests
  public static readonly baseURL: string = 'https://alliancechemical.com';
  ...
  protected static readonly apiURL: string = 'alliance-chemical-store.myshopify.com';
