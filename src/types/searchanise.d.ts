declare global {
  /**
   * Represents a category in the Searchanise store.
  ...
  /**
   * Represents a page in the Searchanise store.
  ...
  /**
   * Represents product options in Searchanise.
  ...
  /**
   * Represents a product variant in Searchanise.
   * Variants are specific combinations of product options that can be purchased.
   *
   * @example
   * ```typescript
   * const variant: SearchaniseProductVariant = {
   *   variant_id: "123456",
   *   sku: "CHEM-NACL-500G",
  ...
  /**
   * Represents a product item in Searchanise.
  ...
  /**
   * Represents the response from a Searchanise search query.
  ...
  /**
   * Represents the query parameters for a Searchanise search request.
  ...
  interface SearchaniseVariant {
    ...
    /**
     * Unique identifier for the variant in Searchanise's system.
