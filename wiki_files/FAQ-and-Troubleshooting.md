...
searches are run, how many results they return, when the extension is installed or
updated, and when it hits an error — tied only to a random identifier, never your
name or an account. There are
